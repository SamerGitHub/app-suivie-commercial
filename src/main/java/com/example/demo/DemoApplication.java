...
public class DemoApplication implements CommandLineRunner {
    ...
    public void run(String... arg0) throws Exception {
      ...
      TypeEngin tRe2=typeEnginRepository.save(te2);TypeEngin teR3=typeEnginRepository.save(te3);
       ...
       TypeEngin teR6=typeEnginRepository.save(te6);
        ...
        TypeEngin teR7=typeEnginRepository.save(te7);TypeEngin teR8=typeEnginRepository.save(te8);
        ...
        TypeEngin teR9=typeEnginRepository.save(te9);TypeEngin teR10=typeEnginRepository.save(te10);
...
//marque Engin Selon le type d'engin
        ...
        mqCat1.setTypeEngin(teR6);Marque mqR1=marqueRepository.save(mqCat1);
        System.out.println("mqr1 ::"+mqR1.getId());
        mqCat2.setTypeEngin(teR4);Marque mqR2=marqueRepository.save(mqCat2);
        System.out.println("mqr2 ::"+mqR2.getId());
        mqCat3.setTypeEngin(teR5);Marque mqR3=marqueRepository.save(mqCat3);
        System.out.println("mqr3 ::"+mqR3.getId());
        Marque mq2=new Marque("Hitachi");

        mq2.setTypeEngin(te6);Marque mqR4=marqueRepository.save(mq2);
        mq2.setTypeEngin(te4);Marque mqR5=marqueRepository.save(mq2);
        mq2.setTypeEngin(te5);Marque mqR6=marqueRepository.save(mq2);

        Marque mqVol1=new Marque("Volvo");
        Marque mqVol2=new Marque("Volvo");
        Marque mqVol3=new Marque("Volvo");

        mqVol1.setTypeEngin(te1);Marque mqR7=marqueRepository.save(mqVol1);
        mqVol2.setTypeEngin(te2);Marque mqR8=marqueRepository.save(mqVol2);
        mqVol3.setTypeEngin(te3);Marque mqR9=marqueRepository.save(mqVol3);
        ...
        mqHyn1.setTypeEngin(te6);Marque mqR10=marqueRepository.save(mqHyn1);
        mqHyn2.setTypeEngin(te4);Marque mqR11=marqueRepository.save(mqHyn2);
        mqHyn3.setTypeEngin(te5);Marque mqR12=marqueRepository.save(mqHyn3);

        Marque mqTx1=new Marque("Terex");
        Marque mqTx2=new Marque("Terex");
        Marque mqTx3=new Marque("Terex");

        mqTx1.setTypeEngin(te7);Marque mqR13=marqueRepository.save(mqTx1);
        mqTx2.setTypeEngin(te8);Marque mqR14=marqueRepository.save(mqTx2);
        mqTx3.setTypeEngin(te9);Marque mqR15=marqueRepository.save(mqTx3);
        ...
        mqCas1.setTypeEngin(te6);Marque mqR16=marqueRepository.save(mqCas1);
        mqCas2.setTypeEngin(te4);Marque mqR17=marqueRepository.save(mqCas2);
        mqCas3.setTypeEngin(te5);Marque mqR18=marqueRepository.save(mqCas3);
        mqCas4.setTypeEngin(te5);Marque mqR122=marqueRepository.save(mqCas3);

        Marque mqPoc1=new Marque("Poclain");
        Marque mqPoc2=new Marque("Poclain");
        Marque mqPoc3=new Marque("Poclain");

        mqPoc1.setTypeEngin(te7);Marque mqR19=marqueRepository.save(mqPoc1);
        mqPoc2.setTypeEngin(te8);Marque mqR20=marqueRepository.save(mqPoc2);
        ...
        mqNh1.setTypeEngin(te9);Marque mqR21=marqueRepository.save(mqNh1);
        mqNh2.setTypeEngin(te10);Marque mqR22=marqueRepository.save(mqNh2);


//Modele Engin
        //Catterpillar-chargeuse pelleteuse
        Modele m1=new Modele("428E");m1.setMarque(mqR1);Modele mod1=modeleRepository.save(m1);
        Modele m2=new Modele("428C");m2.setMarque(mqR1);Modele mod2=modeleRepository.save(m2);
        Modele m3=new Modele("428D");m3.setMarque(mqR1);Modele mod3=modeleRepository.save(m3);

        //Volvo-SemiRemorque
        Modele m4=new Modele("FH12");m4.setMarque(mqR7);Modele mod4=modeleRepository.save(m4);
        Modele m5=new Modele("FH16");m5.setMarque(mqR7);Modele mod5=modeleRepository.save(m5);

         //Case-chargeuse pelleteuse
        Modele m6=new Modele("580ST");m6.setMarque(mqR16);Modele mod6=modeleRepository.save(m6);
        Modele m7=new Modele("590ST");m7.setMarque(mqR16);Modele mod7=modeleRepository.save(m7);
        Modele m8=new Modele("695ST");m8.setMarque(mqR16);Modele mod8=modeleRepository.save(m8);

        //catterpillar -chargeur sur pneu
         Modele m9=new Modele("906M");m9.setMarque(mqR2);Modele mod9=modeleRepository.save(m9);
        Modele m10=new Modele("907M");m10.setMarque(mqR2);Modele mod10=modeleRepository.save(m10);
        Modele m11=new Modele("908M");m11.setMarque(mqR2);Modele mod11=modeleRepository.save(m11);


        Modele m12=new Modele("500v");m12.setMarque(mqR7);Modele mod12=modeleRepository.save(m12);
        Modele m13=new Modele("483G");m13.setMarque(mqR8);Modele mod13=modeleRepository.save(m13);
        Modele m14=new Modele("OM40");m14.setMarque(mqR9);Modele mod14=modeleRepository.save(m14);
        Modele m15=new Modele("A720");m15.setMarque(mqR10);Modele mod15=modeleRepository.save(m15);
        Modele m16=new Modele("B850");m16.setMarque(mqR11);Modele mod16=modeleRepository.save(m16);
        Modele m17=new Modele("45E7");m17.setMarque(mqR12);Modele mod17=modeleRepository.save(m17);
        Modele m18=new Modele("630A");m18.setMarque(mqR13);Modele mod18=modeleRepository.save(m18);
        ...
        Engin e1 = new Engin("163TU4773","EnMission");
        Engin e2 = new Engin("101TU9108", "EnPanne");
        Engin e3 = new Engin("7465", "Disponible");
        Engin e4 = new Engin("8465",  "Disponible");
        ...
        e1.setModele(mod1);e2.setModele(mod2);e3.setModele(mod3);e4.setModele(mod4);
...
/*
        Vidange v1=new Vidange("vidange moteur","20w50",new Date(),300f,"dsklfjklsdfj");
        Vidange v2=new Vidange("vidange boite","40M60",new Date(),300f,"aaazeaze");

*/
        Client cl1=new Client("mohammed","ltaif","12345678","sjhjsdhjs@jhjh.com","kalaa kbira");
        Client cl2=new Client("achraf","abdJalil","789566","aaaze@jhjh.com","msaken");
        Client cl3=new Client("hosni","qsdqds","7894546","aaaze@jhjh.com","msaken");
